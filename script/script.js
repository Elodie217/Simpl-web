...
agesauvegarder = sessionStorage.getItem("agesauv");
...
function affichageerreur() {
  ...
  if (age < 18) {
    ...
    sessionStorage.setItem("agesauv", age);
  }
}
...
function choixLangueEn() {
  ...
  document.querySelector(".firstp").innerText =
  ...
  document.querySelector("#premierP").innerText =
    "Generate meaningful discussions with your audience and build a strong, loyal community. Think of the insightful conversations you miss out on with a feedback form. ";
  document.querySelector("#secondH").innerText = "Flowing Conversations";
  document.querySelector("#deuxiemeP").innerText =
    "You wouldn't paginate a conversation in real life, so why do it online ? Our threads have just-in-time loading for a more natural flow. ";
  document.querySelector("#thirdH").innerText = "Your Users";
  document.querySelector("#troisiemeP").innerText =
    "It takes no time at all to integrate Huddle with your app's authentication solution. This means, once signed in to your app, your users can start chatting immediately. ";
  document.querySelector("#fourthH").innerText =
    "Ready To Build Your Community ?";
  document.querySelector(".boutongetstarted").innerText =
    "Get Started For Free";
  document.querySelector(".line-height").innerText =
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium rem neque quisquam fugit ducimus illum aspernatur dicta?";
  ...
  document.querySelector(".copyright").innerHTML =
    '<p><i class="fa-regular fa-copyright"></i>Copyright 2018 Huddle. All rights reserved.</p>';

  // Formulaire en anglais

  document.querySelector(".formulaireTitle").innerText =
    "Start For Free By Filling Out The Form";
  ...
  document.querySelector(".yourExpect").innerText =
    "What do you expect from this community ?";
  document.querySelector(".needFriend").innerText =
  ...
  document.querySelector(".paragrapheTrad1").innerHTML =
  ...
  document.querySelector(".paragrapheTrad2").innerHTML =
    "You wouldn't paginate a conversation in real life, so why do it online ? Our threads have just-in-time loading for a more natural flow.<br/>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque cumque delectus odio perspiciatis quam iste iure similique at corporis assumenda dignissimos ex quas voluptatibus deserunt, eius sit excepturi accusamus eaque.";
  document.querySelector(".articleTrad3").innerText = "Your Users";
  document.querySelector(".paragrapheTrad3").innerHTML =
...
function choixLangueFr() {
  ...
  document.querySelector("#deuxiemeP").innerText =
    "Vous ne pagineriez pas une conversation dans la vraie vie, alors pourquoi le faire en ligne ? Nos fils sont chargés juste à temps pour un flux plus naturel.";
  ...
  document.querySelector(".blog").innerText = "Blog";
  document.querySelector(".copyright").innerHTML =
    '<p><i class="fa-regular fa-copyright"></i>Copyright 2018 Huddle. Tous droits réservés.</p>';

  // Formulaire en français

  document.querySelector(".formulaireTitle").innerText =
    "Commencez gratuitement en remplissant le formulaire";
  ...
  document.querySelector(".yourExpect").innerText =
    "Qu'attendez-vous de cette communauté ?";
  document.querySelector(".needFriend").innerText =
    "Agrandir mon cercle d'amis";
  ...
  document.querySelector(".paragrapheTrad1").innerHTML =
    "Générez des discussions significatives avec votre public et construisez une communauté forte et fidèle. Pensez aux conversations perspicaces que vous manquez avec un formulaire de commentaires.<br/>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque cumque delectus odio perspiciatis quam iste iure similique at corporis assumenda dignissimos ex quas voluptatibus deserunt, eius sit excepturi accusamus eaque.";
  document.querySelector(".articleTrad2").innerText = "Conversations Fluides";
  document.querySelector(".paragrapheTrad2").innerHTML =
    "Vous ne pagineriez pas une conversation dans la vraie vie, alors pourquoi le faire en ligne ? Nos fils sont chargés juste à temps pour un flux plus naturel.<br/>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque cumque delectus odio perspiciatis quam iste iure similique at corporis assumenda dignissimos ex quas voluptatibus deserunt, eius sit excepturi accusamus eaque.";
  document.querySelector(".articleTrad3").innerText = "Vos Utilisateurs";
  document.querySelector(".paragrapheTrad3").innerHTML =
    "L'intégration de Huddle à la solution d'authentification de votre application ne prend aucun temps. Cela signifie qu'une fois connectés à votre application, vos utilisateurs peuvent commencer à discuter immédiatement.</br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque cumque delectus odio perspiciatis quam iste iure similique at corporis assumenda dignissimos ex quas voluptatibus deserunt, eius sit excepturi accusamus eaque.";
...
function choixLangueJa() {
  ...
  document.querySelector("h1").innerText =
    "ファンが気に入るコミュニティを構築する ";
  document.querySelector(".firstp").innerText =
    "Huddle はコミュニティを構築する方法を再考します。あなたには発言権がありますが、視聴者にも発言権があります。本物のディスカッションをしながら、ユーザーとのつながりを築きましょう。";
  document.querySelector(".gsff").innerText = "無料で始めましょう";
  document.querySelector("#firstH").innerText = "共に成長する";
  document.querySelector("#premierP").innerText =
    "視聴者と有意義なディスカッションを生み出し、強力で忠実なコミュニティを構築します。フィードバック フォームで見逃している洞察力に富んだ会話について考えてみましょう。";
  document.querySelector("#secondH").innerText = "流れるような会話";
  document.querySelector("#deuxiemeP").innerText =
    "実生活では会話をページ分割することはないのに、なぜオンラインでそれを行うのでしょうか?私たちのスレッドは、より自然なフローのためにジャストインタイムでロードされます。";
  document.querySelector("#thirdH").innerText = "ユーザー";
  document.querySelector("#troisiemeP").innerText =
    "Huddle をアプリの認証ソリューションと統合するのに時間はかかりません。つまり、アプリにサインインすると、ユーザーはすぐにチャットを開始できるようになります。";
  document.querySelector("#fourthH").innerText =
    "コミュニティを構築する準備はできましたか?";
  document.querySelector("#fourthH").style.fontSize = "18px";
  document.querySelector(".boutongetstarted").innerText = "無料で始めましょう";
  document.querySelector(".line-height").innerText =
    "会社自体は非常に成功している会社です。賛美者この問題を解決しても誰も逃げないのに、私たちはその言葉によって彼を激怒させるだろうか？";
  ...
  document.querySelector(".copyright").innerHTML =
    '<p><i class="fa-regular fa-copyright"></i>著作権 2018 ハドル。無断転載を禁じます。</p>';
  ...
  document.querySelector(".yourPassion").innerText =
    "私の情熱を共有してください";
  ...
  document.querySelector(".paragrapheTrad1").innerHTML =
    "視聴者と有意義なディスカッションを生み出し、強力で忠実なコミュニティを構築します。フィードバック フォームで見逃している洞察力に富んだ会話について考えてみましょう。会社自体は非常に成功している会社です。賛美者この問題を解決しても誰も逃げないのに、私たちはその言葉によって彼を激怒させるだろうか？";
  document.querySelector(".articleTrad2").innerText = "流れるような会話";
  document.querySelector(".paragrapheTrad2").innerHTML =
    "実生活では会話をページ分割することはないのに、なぜオンラインでそれを行うのでしょうか?私たちのスレッドは、より自然なフローのためにジャストインタイムでロードされます。会社自体は非常に成功している会社です。賛美者この問題を解決しても誰も逃げないのに、私たちはその言葉によって彼を激怒させるだろうか？";
  document.querySelector(".articleTrad3").innerText = "ユーザー";
  document.querySelector(".paragrapheTrad3").innerHTML =
    "Huddle をアプリの認証ソリューションと統合するのに時間はかかりません。つまり、アプリにサインインすると、ユーザーはすぐにチャットを開始できるようになります。会社自体は非常に成功している会社です。賛美者この問題を解決しても誰も逃げないのに、私たちはその言葉によって彼を激怒させるだろうか？";
